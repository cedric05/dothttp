...
class Swagger3:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'Swagger3':
        assert isinstance(obj, dict)
        ...
        return Swagger3(components, external_docs, info, openapi, paths, security, servers, tags)
...
def swagger3_from_dict(s: Any) -> Swagger3:
    return Swagger3.from_dict(s)


def swagger3_to_dict(x: Swagger3) -> Any:
    return to_class(Swagger3, x)
