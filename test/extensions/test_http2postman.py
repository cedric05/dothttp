...
class Testhttp2postman(TestBase):
    ...
    def test_simple(self):
        self.execute_n_get(
            expected_output="export1.postman.json",
    ...
    def test_payload(self):
        ...
        """
        self.execute_n_get(
            "payload.postman_collection.json", os.path.join(command_dir, "payload.http")
        )
    ...
    def test_url_query(self):
        ...
        """
        self.execute_n_get(
            "urlquery.postman_collection.json",
            os.path.join(command_dir, "urlquery.http"),
        )
    ...
    def test_negative(self):
        ...
        self.assertTrue(
            second.get("error_message").startswith(
    ...
    def test_extend(self):
        self.execute_n_get(
            "auth_extend.postman_collection.json",
            os.path.join(requests_dir, "auth_extend.http"),
        )

    def test_url_with_port(self):
        self.execute_n_get(
            "url_query.postman_collection.json",
            os.path.join(command_dir, "urlquerywithport.http"),
        )

    def test_unparseble_port(self):
        self.execute_n_get(
            http2postman_dir.joinpath("test_unparseble_port.postman_collection.json"),
            os.path.join(http2postman_dir, "test_unparseble_port.http"),
        )

    def test_aws_auth(self):
        self.execute_n_get(
            http2postman_dir.joinpath("awsauth.postman_collection.json"),
            os.path.join(http2postman_dir, "awsauth.http"),
        )

    def test_export_varibles(self):
        self.execute_n_get(
            http2postman_dir.joinpath(
                "withenv", "exportdothttpenv.postman_collection.json"
            ),
    ...
    def test_folder(self):
        self.execute_n_get(
            http2postman_dir.joinpath(
                "folderupload", "examples.postman_collection.json"
            ),
    ...
    def test_ntlm_auth(self):
        self.execute_n_get(
            http2postman_dir.joinpath("ntlmauth.postman_collection.json"),
