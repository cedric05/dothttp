...
class UrlExtend(TestBase):
    ...
    def test_bothurlparamsinurl(self):
        self.check_url(
            "https://req.dothttp.dev/user/profile?ramu=ranga",
            "bothurlparamsinurl_sub")

    def test_parenturlchildext(self):
        self.check_url(
            "https://req.dothttp.dev/user/profile?ramu=ranga",
            "parenturlchildext_sub")
    ...
    def test_childwithonlyparams(self):
        self.check_url(
            ...
            "childwithonlyparams_sub")

    def test_childwithonlyparamsinurl(self):
        self.check_url(
            "https://req.dothttp.dev/user/?rajesh=ranga",
            "childwithonlyparamsinurl_sub")
    ...
    def test_dontuseurl(
            self,
            assert_url="https://req2.dothttp.dev/user",
            target="dontuseurl_sub"):
