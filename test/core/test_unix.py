...
@skipIf(requests_unixsocket is None or not sys.platform.startswith("linux"),
    ...
    def test_url_extend_and_query(self):
        ...
        with UnixSocketServerThread() as usock_thread:
            ...
            self.assertEqual(
                ...
                "path should be same")
            self.assertEqual('timestamp=true',
                             response2.headers['X-Requested-Query-String'])
