...
class SubstitutionTest(TestBase):
    ...
    def test_str(self):
        ...
        self.assertTrue(
            10 == len(data["test"]), f"this is skeptical {str_request.body}"
        )
    ...
    def test_complex(self):
        ...
        self.assertEqual(
            f"https://req.dothttp.dev/?str={reuse2_str_value}", dataJsonreuse2.url
        )
        ...
        self.assertEqual(
            f"https://req.dothttp.dev/?str={datareuse3.body}", datareuse3.url
        )
